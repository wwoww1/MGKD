...
def get_cifar100_dataloaders(batch_size=128, num_workers=8, is_instance=False,percent=1.0):
    """
    cifar 100
    """
    ...
    if is_instance:
        ...
        if percent < 1.0:
            ...
            num_keep = int(percent * num_total)
            indices = np.random.choice(num_total, num_keep, replace=False)
